(function($) {
	$(function() {
		...
		// Logo
        $('.bonno_upload_image, .bonno_options_header_image img').click(function (e) {
            e.preventDefault();
            currentUploadContainer = $(this).parents('.bonno_options_header_image');
		...
		$('.bonno_delete_image').click(function() {
			currentUploadContainer = $(this).parents('.bonno_options_header_image');
		...
		// Color picker
		$('.bonno-color-picker').wpColorPicker();
	})
})(jQuery)
