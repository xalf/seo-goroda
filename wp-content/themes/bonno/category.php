<?php
/**
 * Template for blog posts categories
 * 
 * @package Aisconverse
 * @subpackage Bonno
 * @since Bonno 1.0
...
<div class="content">
	...
	<div class="content section">
		<?php if ( count( $categories ) && !($categories instanceof WP_Error ) ) { ?>
			<div class="section">
				<ul class="nav-blog">
					<li><a href="<?php echo $archive_page_URL; ?>" class="<?php echo !$cat_id ? 'active': ''; ?>"><?php _e( 'All posts', BONNO_TEXTDOMAIN ); ?><ins>&nbsp;</ins></a></li>
					<?php foreach ($categories as $category) { ?>
						<li><a href="<?php echo get_category_link( $category->term_id ); ?>" class="<?php echo $cat_id == $category->term_id ? 'active': ''; ?>"><?php echo $category->name; ?><ins>&nbsp;</ins></a></li>
					<?php }?>
				</ul>
			</div>
		<?php } ?>
